...
export const Card = () => {
  ...
  return (
    <motion.div
      className="flex h-[200px] cursor-pointer flex-col items-center justify-center overflow-hidden rounded-xl border border-slate-700 bg-slate-900 px-4 text-center shadow-xl w-[400px] mx-3 md:w-[500px]"
